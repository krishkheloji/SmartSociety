<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master"
    AutoEventWireup="true" CodeBehind="VisitorsLog.aspx.cs"
    Inherits="SocietyManagement.Admin.Security.VisitorsLog" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-4">
        <h3 class="mb-3 text-center text-primary">Visitor Logs</h3>

        <div class="card shadow p-4">
            <asp:GridView ID="gvLogs" runat="server" CssClass="table table-bordered table-striped"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CheckOut" HeaderText="Check-Out" DataFormatString="{0:dd-MMM-yyyy HH:mm}" />
                </Columns>
            </asp:GridView>
        </div>
    </div>

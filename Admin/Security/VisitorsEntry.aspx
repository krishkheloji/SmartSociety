<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master"
    AutoEventWireup="true" CodeBehind="VisitorsEntry.aspx.cs"
    Inherits="SocietyManagement.Admin.Security.VisitorsEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-4">
        <h3 class="mb-3 text-center">Add Visitor Entry</h3>

        <div class="card shadow p-4">

            <div class="mb-3">
                <label class="form-label">Select Society</label>
                <asp:DropDownList ID="ddlSociety" runat="server" CssClass="form-select" AutoPostBack="true"
            ...
            <div class="mb-3">
                ...
                <asp:DropDownList ID="ddlBuilding" runat="server" CssClass="form-select" AutoPostBack="true"
            ...
            <div class="mb-3">
                ...
                <asp:TextBox ID="txtVisitorName" runat="server" CssClass="form-control" placeholder="Enter visitor name"></asp:TextBox>
            </div>
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save Entry" CssClass="btn btn-primary w-100" OnClick="btnSave_Click" />

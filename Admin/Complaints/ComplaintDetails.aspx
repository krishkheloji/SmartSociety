<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ComplaintDetails.aspx.cs" Inherits="SocietyManagement.Admin.Complaints.ComplaintDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5 bg-white p-4 rounded shadow">
        <h3 class="border-bottom pb-2 mb-3">All Complaints</h3>

        <div class="mb-3 text-end">
            <a href="AddComplaints.aspx" class="btn btn-success">Add Complaint</a>
        </div>
        ...
        <asp:GridView ID="gvComplaints" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="FlatNumber" HeaderText="Flat Number" ReadOnly="True" />
                ...
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:Button ID="btnView" runat="server" CommandName="ViewComplaint"
                            CommandArgument='<%# Eval("ComplaintId") %>'
                            Text="View" CssClass="btn btn-warning btn-sm" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>

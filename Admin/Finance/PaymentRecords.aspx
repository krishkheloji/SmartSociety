<%@ Page Title="Payment Records" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PaymentRecords.aspx.cs" Inherits="SocietyManagement.Admin.Finance.PaymentRecords" %>
    ...
    <div class="container-fluid mt-3">
        <div class="card">
            ...
            <asp:GridView ID="gvPayments" runat="server" CssClass="table table-bordered table-striped"
                ...
                <Columns>
                    <asp:BoundField HeaderText="Payment ID" DataField="PaymentId" />
                    <asp:BoundField HeaderText="Bill ID" DataField="BillId" />
                    <asp:BoundField HeaderText="Unit No" DataField="UnitNo" />
                    <asp:BoundField HeaderText="Paid On" DataField="PaidOn" DataFormatString="{0:dd-MMM-yyyy}" />
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:Button ID="btnMarkVerified" runat="server" Text="Mark Verified"
                                CommandName="VerifyPayment" CommandArgument='<%# Eval("PaymentId") %>'

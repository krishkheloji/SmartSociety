<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ViewAllBookings.aspx.cs" Inherits="SocietyManagement.Admin.Amenities.ViewAllBookings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <h3 class="mb-4">All Amenity Bookings</h3>

        <div class="mb-3 text-end">
            <asp:Button ID="btnGoToApprovals" runat="server"
                Text="Go to Pending Approvals →"
                CssClass="btn btn-primary"
                OnClick="btnGoToApprovals_Click" />
        </div>

        <asp:Label ID="lblMessage" runat="server" CssClass="text-danger mb-2 d-block"></asp:Label>

        <asp:GridView ID="gvAllBookings" runat="server"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="AmenityName" HeaderText="Amenity" />
                ...
                <asp:BoundField DataField="EndTime" HeaderText="End Time" DataFormatString="{0:yyyy-MM-dd HH:mm}" />
